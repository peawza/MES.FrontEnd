...
// Input  Search
let sc_plant_code, sc_plant_name, sc_status;
...
async function CreateUI() {
    $("#sc-plant-code").kendoTextBox({

    });
    sc_plant_code = $("#sc-plant-code").data("kendoTextBox");
    $("#sc-plant-name").kendoTextBox({

    });
    sc_plant_name = $("#sc-plant-name").data("kendoTextBox");
        ...
        let grid = $(grid_inquire.grid_ID).kendoGrid({
            ...
            columns: [
...

                {
                    ...
                    field: "PlantCode",
                    title: Resources("PMS010", "GD002"),
                    attributes: { class: "k-text-right" },
                    width: "250px"
                },
                {
                    field: "PlantName",
                    title: Resources("PMS010", "GD003"),
                    attributes: { class: "k-text-left" },
                    width: "200px"
                },
                {
                    field: "Status",
                    title: Resources("PMS010", "GD004"),
                    attributes: { class: "k-text-left" },
                    width: "180px",
...

                {
                    ...
                    field: "UpdateBy",
                    title: Resources("PMS010", "GD007"),
                    attributes: { class: "text-left " },
                    width: "200px"
                },
                {
                    field: "UpdateDateTime",
                    title: Resources("PMS010", "GD008"),
                    attributes: { class: "text-center " },
                    width: "160px",
                    template: (data) => {
