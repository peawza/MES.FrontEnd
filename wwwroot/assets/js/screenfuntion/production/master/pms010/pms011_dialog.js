...
let ip_plant_code, ip_plant_name, ip_status
let arryDisableInputNoWorking = ["ip-item-group-name", "ip-status"]
window.addEventListener("load", async (event) => {
    //console.log("load !");
    $("#ip-plant-code").kendoTextBox({
     
    });
    ip_plant_code = $("#ip-plant-code").data("kendoTextBox");
    $("#ip-plant-name").kendoTextBox({

    });
    ip_plant_name = $("#ip-plant-name").data("kendoTextBox");
...
let dialog_windows = {
    ...
    getValue: () => {
        ...
        return {
            FGCode: ip_plant_code.value(),
            FGName: ip_plant_name.value(),
