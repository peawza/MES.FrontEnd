        ...
        let grid = $(grid_inquire.grid_ID).kendoGrid({
            ...
            columns: [
...

                {
                    ...
                    field: "ProcessCode",
                    title: Resources("PMS030", "GD002"),
                    attributes: { class: "k-text-right" },
                    width: "250px"
                },
                //{
                //    field: "ProcessNameTH",
                //    title: Resources("PMS030", "GD003"),
...

                {
                    ...
                    field: "UpdateBy",
                    title: Resources("PMS030", "GD007"),
                    attributes: { class: "text-left " },
                    width: "200px"
                },
                {
                    field: "UpdateDateTime",
                    title: Resources("PMS030", "GD008"),
                    attributes: { class: "text-center " },
                    width: "160px",
                    template: (data) => {
