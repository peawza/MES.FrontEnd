        ...
        let grid = $(grid_inquire.grid_ID).kendoGrid({
            ...
            columns: [
...

                {
                    ...
                    field: "ShiftCode",
                    title: Resources("PMS050", "GD002"),
                    attributes: { class: "k-text-right" },
                    width: "250px"
                },
                {
                    field: "ShiftName",
                    title: Resources("PMS050", "GD003"),
                    attributes: { class: "k-text-left" },
                    width: "200px"
                },
                {
                    field: "ShiftStartTime",
                    title: Resources("PMS050", "GD004"),
                    attributes: { class: "k-text-left" },
                    width: "180px",
...

                {
                    ...
                    field: "UpdateBy",
                    title: Resources("PMS050", "GD009"),
                    attributes: { class: "text-left " },
                    width: "200px"
                },
                {
                    field: "UpdateDateTime",
                    title: Resources("PMS050", "GD010"),
                    attributes: { class: "text-center " },
                    width: "160px",
