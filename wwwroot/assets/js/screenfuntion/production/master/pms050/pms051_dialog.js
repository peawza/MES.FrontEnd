...
let ip_shift_code, ip_shift_name, ip_shift_start_time, ip_shift_end_time, ip_status
...
window.addEventListener("load", async (event) => {
    ...
    ip_shift_start_time = $("#ip-shift-end-time").data("kendoTimePicker");
...
let dialog_windows = {
    ...
    setValue: async (data) => {
        ...
        if (ip_hiden_Mode.val() == "edit") {
            ...
            ip_start_time.value(data.ShiftStartTime)
            ip_end_time.value(data.ShiftEndTime)
            ip_end_time.value(data.ShiftActive)
    ...
    getValue: () => {
        ...
        return {
            ...
            StartTime: kendo.toString(new Date(ip_shift_start_time.value()), "HH:mm:ss"),
            EndTime: kendo.toString(new Date(ip_shift_end_time.value()), "HH:mm:ss"),
