...
public class ResourcesString
{
    ...
    public ResourcesString(string name, string value, bool resourceNotFound)
    ...
    public ResourcesString(string name, string value, bool resourceNotFound, string? searchedLocation)
    {
        if (name == null)
        {
    ...
    /// <summary>
    /// Implicitly converts the <see cref="ResourcesString"/> to a <see cref="string"/>.
    /// </summary>
    /// <param name="localizedString">The string to be implicitly converted.</param>
    [return: NotNullIfNotNull("localizedString")]
    public static implicit operator string?(ResourcesString localizedString)
    {
